...
<c:choose>
	...
	<c:otherwise>
		...
		<aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' cssClass="sign-in-form form-signin" method="post" name="fm">
			...
			<aui:fieldset>
				...
				<aui:input autoFocus="<%= windowState.equals(LiferayWindowState.EXCLUSIVE) || windowState.equals(WindowState.MAXIMIZED) %>" cssClass="clearable"  name="login" showRequiredLabel="<%= false %>" label="" type="text" placeholder="Email">
					<aui:validator name="required" />
				</aui:input>

				<aui:input name="password" showRequiredLabel="<%= false %>" type="password" label="" placeholder="Password">
					<aui:validator name="required" />
				</aui:input>
			...
			<aui:button-row cssClass="text-center">
				<aui:button type="submit" value="Log in" />
			</aui:button-row>
		</aui:form>
